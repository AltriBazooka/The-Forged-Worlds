...
export default function AboutPage() {
  return (
    <div className="container px-4 py-8 md:px-6 md:py-12">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">About The Forged Worlds</h1>
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
        <div>
          ...
          <p className="text-muted-foreground mb-4">
            Founded in 2015, The Forged Worlds started with a simple mission: to provide high-quality products for pets and make pet
        ...
        <div className="relative h-[300px] md:h-[400px] rounded-lg overflow-hidden">
          <Image
            ...
            alt="The Forged Worlds team with pets"
            fill
      ...
      <div className="mb-16">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            At The Forged Worlds, our core values guide everything we do, from product selection to customer service.
          </p>
        </div>
      ...
      <div className="mb-16">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            The passionate people behind The Forged Worlds who work tirelessly to bring the best products to you and your pets.
          </p>
        </div>
      ...
      <div className="bg-primary text-primary-foreground rounded-lg p-8 md:p-12 text-center">
        <h2 className="text-2xl md:text-3xl font-bold mb-4">Join The Forged Worlds Family</h2>
        <p className="max-w-2xl mx-auto mb-6">
          Discover premium products for your furry friends and join thousands of satisfied pet parents who trust The Forged Worlds.
        </p>
