              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      <a href="mailto:info@theforgedworlds.com" className="hover:text-primary">
                        info@theforgedworlds.com
                      </a>
                    </p>
                    <p className="text-muted-foreground">
                      <a href="mailto:support@theforgedworlds.com" className="hover:text-primary">
                        support@theforgedworlds.com
                      </a>
                    </p>
                  </div>
                </div>
